...
MessageType = Enum('PROCESS_STATE_CHANGE', 'ACTION_START', 'ACTION_STOP', 'ACTION_ERROR',
                   ...
                   'ERROR', 'DATA', 'LOG',
                   'EXTEND_SOURCE_GET_ID', 'EXTEND_SOURCE_GET_DATA', 'EXTEND_EXTERNAL_DATA_GET_ID', 'EXTEND_EXTERNAL_DATA_GET_DATA',
                   'EXTEND_EC_PARAM_SEND_ID', 'EXTEND_EC_PARAM_SEND_DATA', 'EXTEND_EXTERNAL_EC_PARAM_SEND_ID', 'EXTEND_EXTERNAL_EC_PARAM_SEND_DATA',
                   'EXTEND_EC_PARAM_RETURN_ID', 'EXTEND_EC_PARAM_RETURN_DATA', 'EXTEND_EXTERNAL_EC_PARAM_RETURN_ID',
                   'EXTEND_EXTERNAL_EC_PARAM_RETURN_DATA', 'FLOW_CONTROL_EXTERNAL_EC_EXECUTE_NOW_START',
                   'FLOW_CONTROL_EXTERNAL_EC_EXECUTE_NOW_EXECUTE',
                   'FLOW_CONTROL_EXTERNAL_EC_EXECUTE_NOW_UPDATE', 'FLOW_CONTROL_EXTERNAL_EC_EXECUTE_NOW_STOP',
                   'FLOW_CONTROL_EXTERNAL_EC_EXECUTE_PARALLEL_START',
                   'FLOW_CONTROL_EXTERNAL_EC_EXECUTE_PARALLEL_EXECUTE', 'FLOW_CONTROL_EXTERNAL_EC_EXECUTE_PARALLEL_UPDATE',
                   'FLOW_CONTROL_EXTERNAL_EC_EXECUTE_PARALLEL_STOP',
                   'FLOW_CONTROL_EXTERNAL_EC_EXECUTE_PARALLEL_WAITING_TACTS',
                   )
...
MessageType.EXTEND_SOURCE_GET_ID.value = 301
MessageType.EXTEND_SOURCE_GET_DATA.value = 302
MessageType.EXTEND_EXTERNAL_DATA_GET_ID.value = 303
MessageType.EXTEND_EXTERNAL_DATA_GET_DATA.value = 304
MessageType.EXTEND_EC_PARAM_SEND_ID.value = 305
MessageType.EXTEND_EC_PARAM_SEND_DATA.value = 306
MessageType.EXTEND_EXTERNAL_EC_PARAM_SEND_ID.value = 307
MessageType.EXTEND_EXTERNAL_EC_PARAM_SEND_DATA.value = 308
MessageType.EXTEND_EC_PARAM_RETURN_ID.value = 309
MessageType.EXTEND_EC_PARAM_RETURN_DATA.value = 310
MessageType.EXTEND_EXTERNAL_EC_PARAM_RETURN_ID.value = 311
MessageType.EXTEND_EXTERNAL_EC_PARAM_RETURN_DATA.value = 312
MessageType.FLOW_CONTROL_EXTERNAL_EC_EXECUTE_NOW_START.value = 229
MessageType.FLOW_CONTROL_EXTERNAL_EC_EXECUTE_NOW_EXECUTE.value = 230
MessageType.FLOW_CONTROL_EXTERNAL_EC_EXECUTE_NOW_UPDATE.value = 231
MessageType.FLOW_CONTROL_EXTERNAL_EC_EXECUTE_NOW_STOP.value = 232
MessageType.FLOW_CONTROL_EXTERNAL_EC_EXECUTE_PARALLEL_START.value = 233
MessageType.FLOW_CONTROL_EXTERNAL_EC_EXECUTE_PARALLEL_EXECUTE.value = 234
MessageType.FLOW_CONTROL_EXTERNAL_EC_EXECUTE_PARALLEL_UPDATE.value = 235
MessageType.FLOW_CONTROL_EXTERNAL_EC_EXECUTE_PARALLEL_STOP.value = 236
MessageType.FLOW_CONTROL_EXTERNAL_EC_EXECUTE_PARALLEL_WAITING_TACTS.value = 237
